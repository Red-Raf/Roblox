...
do
    ...
    do
        ...
        do
            ...
            v3 = unpack or table.unpack
            t2[1] = game:GetService("Players").LocalPlayer
            ...
            t2[8] = nil
            t2[8] = function()
                local v233 = t2[7](t2[8], "nfS")
                local source
                if v233 then
                    source = v233.source

                    if type(source) ~= "string" or source == "" then
                        source = v233.short_src
                    end
                end
                if type(source) ~= "string" or source == "" then
                    if not (v233 and v233.func ~= nil) then
                    end
                end
                local v235 = v233
                local n1 = 0
                ...
                for i = 1, 30 do
                    local v238 = t2[7](i, "nfS")

                    if not v238 then
                        break
                    end

                    local source2 = v238.source

                    if type(source2) ~= "string" or source2 == "" then
                        source2 = v238.short_src
                    end

                    local v240 = false
                    local func = v238.func
                    ...
                    if func then
                        ...
                        local v242 = type(source2) == "string"

                        if v242 then
                            v242 = type(source) == "string"

                            if v242 then
                                v242 = source2 ~= "" and source2 == source
                            end
                        end

                        if v242 then
                            v240 = true
                        elseif v238.func and source2 == nil then
                            v240 = true
                        end
                    end

                    if v240 and v238.func then
                        t2[2][v238.func] = true
                        n1 += 1
                    end
                end
                if n1 == 0 then
                    t2[2][v233 and v233.func or 0] = true
                end

                return true, "self-marking: ok"
            end
            t2[9] = function(p4)
                if not p4 then
                    return false
                ...
                local source = p4.source

                if source then
                    source = t2[4] and p4.source == t2[4]
                end
            ...
            t2[10] = function(p5)
                ...
                if v220:sub(1, 1) == "=" then
                    return true
                end

                local v221 = v220:find("pcall")

                if not v221 then
                    v221 = v220:find("xpcall")

                    if not v221 then
                        v221 = v220:find("loadstring")

                        if not v221 then
                            v221 = v220:find("load") or v220:find("require")
                        end
                    end
                end
            ...
            t2[11] = function(p6)
                ...
                while true do
                    ...
                    local v248 = t2[7](n2, "nfS")

                    if not v248 then
                        return t3
                    end

                    local source = v248.source

                    if type(source) ~= "string" or source == "" then
                        source = v248.short_src
                    end

                    local str = tostring(v248.func or (source or n2))

                    if not t4[str] then
                        t4[str] = true

                        local insert = table.insert
                        local v252 = source or "=?"
                        local v253 = v248.what or "?"
                        local v254 = v248.name or "?"
                        local v255 = v248.namewhat or "?"
                        local func = v248.func
                        local v257 = t2[10](source)
            ...
            t2[12] = function(p7)
                ...
                while true do
                    ...
                    if (not v261 or not (v259 <= n4)) and (v261 or not (n4 <= v259)) then
                        break
                    end

                    local v263 = (p7[n4].name or ""):lower()

                    if v263 == "pcall" or v263 == "xpcall" then
                        n3 += 1
                    end
                end

                if n3 >= 2 then
                    return true, "Pcall wraps dynamic load"
                end
            ...
            t2[13] = function(p8)
                ...
                local t5 = {}
                for v268, v269 in ipairs(p8) do

                    local isDynamic = v269.isDynamic

                    if not isDynamic then
                        isDynamic = t2[10](v269.source)
                    end

                    if isDynamic and not t2[9](v269) then
                        table.insert(t5, v269)
                    end
                end
                if #t5 < 2 then
                    local n5 = 0
                    for v274, v275 in ipairs(p8) do

                        local name = v275.name

                        if name then
                            name = v275.name:lower():find("pcall")

                            if not name then
                                name = v275.name:lower():find("xpcall")

                                if not name then
                                    name = v275.name:lower():find("loadstring")

                                    if not name then
                                        name = v275.name:lower():find("load")

                                        if not name then
                                            name = v275.name:lower():find("require")
                                        end
                                    end
                                end
                            end
                    ...
                    if n5 >= 2 then
                        return true, "Dual load: suspicious dynamic stack"
                    end
                ...
                local n6 = 0
                for v283 in pairs(t6) do

                    n6 += 1
                end
                if n6 >= 2 then
                    return true, "Dual load: " .. n6 .. " unique dynamic sources"
                end

                return true, "Dual load: dynamic stack detected"
            end
            t2[14] = function()
                local v284 = t2[11](24)
                if #v284 == 0 then
                    return true, "stack inspection unavailable"
                end
                local t7, v286 = t2[12](v284)
                if t7 then
                    return true, v286
                end
                local t8, v288 = t2[13](v284)
                if t8 then
                    return true, v288
                end
            ...
            t2[15] = function()
                ...
                return t2[5].RenderStepped:Connect(function()
                    if t2[3] then
                        return
                    end
                    n7 += 1
            ...
            t2[16] = function()
                ...
                return t2[5].Heartbeat:Connect(function()
                    if t2[3] then
                        return
                    end
                    n8 += 1
                    ...
                    local t10, v1123 = t2[14]()
                    if t10 then
                        t2[6]("Loader-HB: " .. v1123)
                    end
                end)
            end
            ...
            do
                local success, result = pcall(function()
                    local v291, v292 = t2[8]()

                    if not v291 then
                        t2[6]("Initial: " .. tostring(v292))

                        return
                    end

                    local v293, v294 = t2[14]()
        ...
        t1[19] = t13
        t1[20] = "pl"
        t1[22] = game:GetService("Players")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "w"
        t1[22] = game:GetService("Workspace")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "rs"
        t1[22] = game:GetService("RunService")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "cg"
        t1[22] = game:GetService("CoreGui")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "cam"
        t1[21] = t13.w.CurrentCamera
        t1[19][t1[20]] = t1[21]
        t1[19] = t13
        t1[20] = "hs"
        t1[22] = game:GetService("HttpService")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "uis"
        t1[22] = game:GetService("UserInputService")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "ts"
        t1[22] = game:GetService("TweenService")
        t1[19][t1[20]] = t1[22]
        t1[19] = t13
        t1[20] = "lp"
        t1[21] = t13.pl.LocalPlayer
        t1[19][t1[20]] = t1[21]
        t1[20] = Color3.fromRGB(136, 0, 255)

        do
            local v16 = t1[20]

            t1[21] = Color3.fromRGB(235, 149, 22)

            local v17 = t1[21]

            t1[22] = Color3.fromRGB(131, 224, 255)

            local v18 = t1[22]

            t1[24] = Color3.fromRGB(25, 69, 87)

            local v19 = t1[24]

            t1[23] = Color3.fromRGB(211, 34, 34)

            local v20 = t1[23]

            t1[25] = Color3.fromRGB(130, 59, 59)
            ...
            t1[25][t1[27]] = {}
            t1[25] = t13
            t1[27] = "PredictionEnabled"
            t1[25][t1[27]] = true
            t1[25] = t13
            t1[27] = "PredictionMultiplier"
            t1[25][t1[27]] = 16.5
            t1[25] = t13
            t1[27] = "YClampMin"
            t1[25][t1[27]] = -2
            ...
            t1[25][t1[27]] = 2.65
            t1[25] = t13
            t1[27] = "SilentAimEnabled"
            t1[25][t1[27]] = false
            t1[25] = t13
            t1[27] = "silentAimCooldown"
            t1[25][t1[27]] = 0
            ...
            t1[25] = t13
            t1[28] = "espSettings"
            t1[31] = Color3.fromRGB(255, 80, 80)
            t1[33] = Color3.fromRGB(80, 140, 255)
            t1[35] = Color3.fromRGB(170, 255, 170)
            t1[37] = Color3.fromRGB(255, 215, 0)
            ...
            t1[25] = t13
            t1[28] = "coinEspObjects"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "coinHighlightObjects"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "espObjects"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "highlightObjects"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "gunEspObjects"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "gunHighlightObjects"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "Connections"
            t1[25][t1[28]] = {}
            ...
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "normalWalkSpeed"
            t1[25][t1[28]] = 16
            t1[25] = t13
            t1[28] = "TouchFlingEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "touchFlingThread"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoGrab"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AutoThrowEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "notifiedGunDrops"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "AutoKillAllEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AutoKillMurdererEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "killingPlayer"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "currentMurderer"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "currentSheriff"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "roleAssigned"
            t1[25][t1[28]] = false
            ...
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "InfJumpEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "SpeedGlitchEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AntiFlingEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AntiVoidEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "InvisibleEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "antiVoidPart"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmOriginalNoclipState"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "prevRoles"
            t1[25][t1[28]] = {}
            ...
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "flingOldCameraSubject"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "flingConnection"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "flingAngle"
            t1[25][t1[28]] = 0
            ...
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "flingOriginalFallenHeight"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "flickInProgress"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "flingVelConn"
            t1[25][t1[28]] = nil
            ...
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "gunDropNotifyEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "flingQueue"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "flingQueueIndex"
            t1[25][t1[28]] = 1
            t1[25] = t13
            t1[28] = "isFlingingAll"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "TriggerBotEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "TriggerBotShiftLockOnly"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "TrickshotEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "DualEffectEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "DualEffectSelected"
            t1[25][t1[28]] = "Electric"
            t1[25] = t13
            t1[28] = "BombJumpEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "BombJumpAutoGet"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "BombJumpOnCooldown"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "BombJumpDebounce"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "BombJumpJustRespawned"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "FEAnimEnabled"
            t1[25][t1[28]] = false
            ...
            t1[25] = t13
            t1[28] = "FEAnimOriginals"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "AutoFarmEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AutoFarmTweenSpeed"
            t1[25][t1[28]] = 25
            t1[25] = t13
            t1[28] = "AutoFarmThread"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmActiveTween"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmCurrentTargetCoin"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmLastProfileRefresh"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "AutoFarmPostActionCooldown"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "AutoFarmBodyMovers"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "AutoFarmCoinRegistry"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "AutoFarmCoinConnections"
            t1[25][t1[28]] = {}
            t1[25] = t13
            t1[28] = "PostFarmKillMurd"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "PostFarmKillAll"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "PostFarmFlingMurd"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "postfarmresetin"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "postfarmresetsh"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "postfarmresetmurd"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AimlockEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AimlockMurderer"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AimlockSheriff"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AimlockSelected"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AimlockSmoothness"
            t1[25][t1[28]] = 10
            t1[25] = t13
            t1[28] = "aimlockRenderConn"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "aimlockOldCameraType"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "aimlockOldCameraSubject"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "WebhookEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "WebhookURL"
            t1[25][t1[28]] = ""
            t1[25] = t13
            t1[28] = "WebhookInterval"
            t1[25][t1[28]] = 10
            t1[25] = t13
            t1[28] = "WebhookLastSent"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "WebhookOnFull"
            t1[25][t1[28]] = false
            ...
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "CoinsCollected"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "RoundStartTime"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "AutoFarmSessionCoinsCollected"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "AutoFarmSessionStartTime"
            t1[25][t1[28]] = 0
            t1[25] = t13
            t1[28] = "AutoFarmSessionXPStart"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmSessionLevelStart"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmProfileXP"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoFarmProfileLevel"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "WebhookThread"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoRejoinEnabled"
            t1[25][t1[28]] = false
            t1[25] = t13
            t1[28] = "AutoRejoinTarget"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "AutoRejoinThread"
            t1[25][t1[28]] = nil
            t1[25] = t13
            t1[28] = "antiFlingBlacklist"
            t1[25][t1[28]] = {
				BodyVelocity = true,
				BodyGyro = true,
				BodyThrust = true,
            ...
            function savePosition(p48, p49)
                task.spawn(function()
                    pcall(function()
                        if not isfolder("pressurehub/configs") then
                            makefolder("pressurehub/configs")
                        end

                        local t24 = {}

                        if isfile("pressurehub/configs/positions.json") then
                            local ok, result = pcall(function()
                                local hs = t13.hs
                                local t25 = { readfile("pressurehub/configs/positions.json") }
                        ...
                        writefile("pressurehub/configs/positions.json", t13.hs:JSONEncode(t24))
                    end)
                end)
            end
            function loadPosition(p50, p51)
                local ok, result = pcall(function()
                    if not isfile("pressurehub/configs/positions.json") then
                        return nil
                    end

                    local hs = t13.hs
                    local t26 = { readfile("pressurehub/configs/positions.json") }
            ...
            do
                ...
                t1[25][t1[28]] = {
					...
					["Zombie FE"] = t1[56],
					["Catwalk Glam"] = t1[58],
					["Amazon Unboxed"] = t1[60],
					["Glow Motion"] = t1[62],
					Bubbly = t1[64],
					["Adidas Comm"] = t1[66],
					KATSEYE = t1[68],
					["Wicked Popular"] = t1[70]
				}
            end
            ...
            t13.SaveFEAnimOriginals = t1[25]
            t1[25] = function(p54, p55)
                ...
                for k, v in pairs(p54.FEAnimMap) do
                    ...
                    if vfolder then
                        for _, v11 in ipairs(v.slots) do
                            local v11child = vfolder:FindFirstChild(v11.child)
                            local v577 = v11child

                            if v11child then
                                v577 = v11child:IsA("Animation")
                            end

                            if v577 then
                                if v572 == "Default" then
                                    if p54.FEAnimOriginals[v11.origKey] then
                                        v11child.AnimationId = p54.FEAnimOriginals[v11.origKey]
                                    end
                                else
                                    local v578 = p54.FEAnimPresets[v572]

                                    if v578 and v578[v11.origKey] then
                                        v11child.AnimationId = v578[v11.origKey]
                                    end
                                end
                            end
                        end
            ...
            t13.ApplyFEAnims = t1[25]
            t1[25] = function(p56, p57)
                ...
                for _, v in pairs(p56.FEAnimMap) do
                    ...
                    if vfolder then
                        for _, v15 in ipairs(v.slots) do
                            local v15child = vfolder:FindFirstChild(v15.child)
                            local v594 = v15child

                            if v15child then
                                v594 = v15child:IsA("Animation")

                                if v594 then
                                    v594 = p56.FEAnimOriginals[v15.origKey]
                                end
                            end

                            if v594 then
                                v15child.AnimationId = p56.FEAnimOriginals[v15.origKey]
                            end
                        end
                    end
                end
            ...
            t13.RestoreFEAnimOriginals = t1[25]
            t1[25] = t13
            t1[28] = "lockedButtons"
            t1[25][t1[28]] = {}
            ...
            function saveLockConfig()
                pcall(function()
                    ...
                    writefile("pressurehub/configs/locks.json", t13.hs:JSONEncode(t37))
                end)
            end
            function loadLockConfig()
                pcall(function()
                    if not isfile("pressurehub/configs/locks.json") then
                        return
                    end

                    local data = t13.hs:JSONDecode(readfile("pressurehub/configs/locks.json"))
            ...
            t1[29] = function()
                t13.lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Footagesus/WindUI/refs/heads/main/source.lua"))()
                -- WindUI adapter: emulate Obsidian Toggles/Options interface
                t13.lib.Toggles = {}
                t13.lib.Options = {}
                t13.lib._windui_callbacks = {}
                local function _makeToggle(flag, default)
                    local obj = {Value = default or false, _callbacks = {}}
                    function obj:OnChanged(cb) table.insert(self._callbacks, cb) end
                    function obj:SetValue(v)
                        self.Value = v
                        for _, cb in ipairs(self._callbacks) do pcall(cb, v) end
                    end
                    t13.lib.Toggles[flag] = obj
                    return obj
                end
                local function _makeSlider(flag, default)
                    local obj = {Value = default or 0, _callbacks = {}}
                    function obj:OnChanged(cb) table.insert(self._callbacks, cb) end
                    function obj:SetValue(v)
                        self.Value = v
                        for _, cb in ipairs(self._callbacks) do pcall(cb, v) end
                    end
                    t13.lib.Options[flag] = obj
                    return obj
                end
                local function _makeDropdown(flag, default)
                    local obj = {Value = default, _callbacks = {}}
                    function obj:OnChanged(cb) table.insert(self._callbacks, cb) end
                    function obj:SetValues(vals) end
                    function obj:SetValue(v)
                        self.Value = v
                        for _, cb in ipairs(self._callbacks) do pcall(cb, v) end
                    end
                ...
                local function _makeKeybind(flag, default)
                    local obj = {Value = default, _clickCallbacks = {}, _callbacks = {}}
                    function obj:OnClick(cb) table.insert(self._clickCallbacks, cb) end
                    function obj:OnChanged(cb) table.insert(self._callbacks, cb) end
                    function obj:SetValue(v)
                        self.Value = v
                        for _, cb in ipairs(self._callbacks) do pcall(cb, v) end
                    ...
                    t13.lib.Options[flag] = obj
                    -- Wire keybind to fire OnClick callbacks
                    game:GetService("UserInputService").InputBegan:Connect(function(inp, gpe)
                        if gpe then return end
                        if inp.KeyCode == Enum.KeyCode[tostring(default or "Unknown"):upper():gsub(" ","_")] then
                            for _, cb in ipairs(obj._clickCallbacks) do pcall(cb) end
                        end
                    end)
                    return obj
                end
                local function _makeInput(flag, default)
                    local obj = {Value = default or "", _callbacks = {}}
                    function obj:OnChanged(cb) table.insert(self._callbacks, cb) end
                    function obj:SetValue(v)
                        self.Value = v
                        for _, cb in ipairs(self._callbacks) do pcall(cb, v) end
                ...
                -- Wrap groupbox-like sections with WindUI AddSection
                local function _wrapSection(section)
                    local gb = {}
                    function gb:AddToggle(flag, opts)
                        local def = opts.Default or false
                        local cb = opts.Callback
                        local tog = _makeToggle(flag, def)
                        if cb then tog:OnChanged(cb) end
                        section:AddToggle({
                            ...
                            Callback = function(v)
                                tog.Value = v
                                for _, c in ipairs(tog._callbacks) do pcall(c, v) end
                            end
                        })
                        return tog
                    end
                    function gb:AddSlider(flag, opts)
                        ...
                        local cb = opts.Callback
                        local sl = _makeSlider(flag, def)
                        if cb then sl:OnChanged(cb) end
                        section:AddSlider({
                            Name = opts.Text or flag,
                            Default = def,
                            Min = opts.Min or 0,
                            ...
                            Callback = function(v)
                                sl.Value = v
                                for _, c in ipairs(sl._callbacks) do pcall(c, v) end
                            end
                        })
                        return sl
                    end
                    function gb:AddDropdown(flag, opts)
                        ...
                        local def = (type(opts.Default) == "number" and vals[opts.Default]) or opts.Default or (vals[1])
                        local cb = opts.Callback
                        local dd = _makeDropdown(flag, def)
                        if cb then dd:OnChanged(cb) end
                        section:AddDropdown({
                            Name = opts.Text or flag,
                            Default = def,
                            Options = vals,
                            ...
                            Callback = function(v)
                                dd.Value = v
                                for _, c in ipairs(dd._callbacks) do pcall(c, v) end
                            end
                        })
                        return dd
                    end
                    function gb:AddButton(text, cb)
                        section:AddButton({Name = text, Callback = cb or function() end})
                    end
                    function gb:AddLabel(text, richtext)
                        local lbl = {_callbacks = {}}
                        function lbl:SetText(t)
                            -- labels in WindUI are static; we recreate or just skip live updates
                        end
                        function lbl:AddKeyPicker(flag, opts)
                            local kb = _makeKeybind(flag, opts.Default)
                            section:AddKeybind({
                                Name = opts.Text or flag,
                                ...
                                Callback = function(v)
                                    kb.Value = v
                                    for _, c in ipairs(kb._callbacks) do pcall(c, v) end
                                end
                            })
                            return kb
                        end
                        section:AddParagraph({Name = text, Content = ""})
                        return lbl
                    end
                    function gb:AddInput(flag, opts)
                        local def = opts.Default or ""
                        local cb = opts.Callback
                        local inp = _makeInput(flag, def)
                        if cb then inp:OnChanged(cb) end
                        section:AddTextBox({
                            Name = opts.Text or flag,
                            Default = def,
                            Flag = flag,
                            Callback = function(v)
                                inp.Value = v
                                for _, c in ipairs(inp._callbacks) do pcall(c, v) end
                            end
                        })
                        return inp
                    end
                ...
                local function _wrapTab(tab)
                    ...
                    function t:AddLeftGroupbox(name)
                        local sec = tab:AddSection({Name = name, Side = "Left"})
                        return _wrapSection(sec)
                    end
                    function t:AddRightGroupbox(name)
                        local sec = tab:AddSection({Name = name, Side = "Right"})
                        return _wrapSection(sec)
                    end
                    return t
                end
                t13.lib._wrapTab = _wrapTab
                t13.lib._wrapSection = _wrapSection
                t13.lib._makeToggle = _makeToggle
                t13.lib._makeSlider = _makeSlider
                t13.lib._makeDropdown = _makeDropdown
                t13.lib._makeKeybind = _makeKeybind
                t13.lib._makeInput = _makeInput
                t13.lib.AddDraggableLabel = function(lib, text)
                    local lbl = {_text = text, _callbacks = {}}
                    function lbl:SetText(t) self._text = t end
                    function lbl:SetVisible(v) end
                    function lbl:Destroy() end
                    return lbl
                end
                t13.lib.Notify = function(lib, opts)
                    pcall(function()
                        lib:Notify({
            ...
            function createDraggableButton(p72, p73, p74)
                ...
                UIGradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, v19),
					ColorSequenceKeypoint.new(0.35, v16),
					ColorSequenceKeypoint.new(0.5, v16),
					ColorSequenceKeypoint.new(0.65, v19),
                    ...
                    elseif v.Name == t13.killingPlayer then
                        ...
                        if not v796 then
                            ...
                            if v792 then
                                ...
                                for _, v24 in pairs(v779.box) do
                                    v24.Visible = false
                                end
                            end
        ...
        function savePredictionConfig()
            task.spawn(function()
                ...
                writefile("pressurehub/configs/prediction.json", t13.hs:JSONEncode(t41))
            end)
        end
        function loadPredictionConfig(p94, p95, p96, p97)
            if not isfile("pressurehub/configs/prediction.json") then
                return
            end

            local ok, result = pcall(function()
                local hs = t13.hs
                local t42 = { readfile("pressurehub/configs/prediction.json") }
        ...
        if t1[25] then
            error("[LW.X0] Library load critical failure: " .. tostring(t1[26]))
        ...
        t1[31] = function()
            t13.SaveManager = {
                _lib = t13.lib,
                _folder = "pressurehub/configs/mm2",
                BuildConfigSection = function(self, tab) end,
                LoadAutoloadConfig = function(self) end,
                IgnoreThemeSettings = function(self) end,
                SetLibrary = function(self, lib) self._lib = lib end,
                SetFolder = function(self, f) self._folder = f end,
                SetSubFolder = function(self, f) self._folder = self._folder .. "/" .. f end,
            }
        end

        local ok3, result3 = pcall(t1[31])

        t1[29] = ok3
        t1[30] = result3

        if not t1[29] then
            warn("[LW.X1] SaveManager failed: " .. tostring(t1[30]))
        end

        t1[33] = function()
            t13.load = {
                _step = 0,
                SetMessage = function(self, msg) end,
                SetDescription = function(self, msg) end,
                SetCurrentStep = function(self, n) self._step = n end,
                ShowSidebarPage = function(self, v) end,
                Sidebar = { AddLabel = function(self, text) end },
                Continue = function(self) end,
            }
        end

        local ok4, result4 = pcall(t1[33])
        ...
        function sendAutoFarmWebhook(p112, p113, p114)
            ...
            pcall(function()
                ...
                local t55 = {
					text = "pressurehub • https://pressurehub.filho.wtf"
				}
                local v1396 = os.date("!%Y-%m-%dT%H:%M:%SZ")
                local t56 = {
					title = v1376,
					url = "https://pressurehub.filho.wtf",
					description = v1382,
					color = v1383,
					author = t49,
					thumbnail = t50,
        ...
        function startAutoFarm()
            ...
            t13.AutoFarmThread = task.spawn(function()
                ...
                t13.AutoFarmStartCFrame = nil            end)
        end
        ...
        t1[33] = t13
        t1[34] = "version"
        t1[36] = fetch("https://pressurehub.filho.wtf/version.lua", "v0.0.5")
        t1[33][t1[34]] = t1[36]
        ...
        t1[36] = function()
            ...
            local win = lib:CreateWindow({
                Name = "pressurehub",
                Logo = "rbxassetid://75906478682519",
                Intro = true,
                IntroText = "pressurehub",
                Theme = "Sky",
            ...
            v956.window = {
                _win = win,
                Toggle = function(self) win:Toggle() end,
                AddTab = function(self, name, icon)
                    local tab = win:AddTab({Name = name, Logo = icon or ""})
                    local wrapped = t13.lib._wrapTab(tab)
                    wrapped._raw = tab
                    return wrapped
                end,
                AddDialog = function(self, id, opts)
                end,
            }
            t13.lib.Notify = function(lib2, opts)
                pcall(function()
                    win:Notify({
                        Title = opts.Title or "Notice",
                        Content = opts.Description or opts.Content or "",
        ...
        if not t1[37] then
            t1[33] = not t13.window
        end

        if t1[33] then
            error("[LW.X3] Window creation critical failure: " .. tostring(t1[35]))
        ...
        t1[43] = function()
            setclipboard("pressurehub.filho.wtf")
        end
    ...
    do
        ...
        t1[40] = t13.t.c:AddLeftGroupbox("Kill Murderer")
        t1[42] = t13.t.c:AddRightGroupbox("Silent Aim")
        t1[44] = t13.t.c:AddLeftGroupbox("Auto Throw Nearest")
        t1[46] = t13.t.c:AddRightGroupbox("Kill")
        t1[48] = t13.t.c:AddLeftGroupbox("Trigger Bot")
        t1[50] = t13.t.af:AddLeftGroupbox("Farm")
        t1[52] = t13.t.af:AddRightGroupbox("When Full")
        t1[54] = t13.t.af:AddLeftGroupbox("Webhook")
        t1[36][t1[38]] = {
			esp = v59,
			outline = v60,
			chams = v61,
        ...
        t1[40] = t13.t.lp:AddLeftGroupbox("Anti Fling")
        t1[42] = t13.t.lp:AddRightGroupbox("Anti Void")
        t1[36][t1[38]] = {
			noclip = v66,
			xray = v67,
			invisible = v68,
    ...
    do
        ...
        t1[40] = t13.t.g:AddRightGroupbox("Touch Fling")
        t1[42] = t13.t.g:AddLeftGroupbox("Coin Aura")
        t1[44] = t13.t.g:AddRightGroupbox("Trickshot")
        t1[46] = t13.t.g:AddLeftGroupbox("Dual Effect")
        t1[48] = t13.t.g:AddRightGroupbox("Bomb Jump")
        t1[50] = t13.t.g:AddLeftGroupbox("FE Animations")
        t1[36][t1[38]] = {
			status = v75,
			prediction = v76,
			timer = v77,
        ...
        t1[36][t1[38]] = ScreenGui
        t1[36] = t13.floatingGui
        t1[38] = "Name"
        t1[36][t1[38]] = "pressurehub_Floating"
        t1[36] = t13.floatingGui
        t1[38] = "ResetOnSpawn"
        t1[36][t1[38]] = false
        t1[36] = t13.floatingGui
        ...
        t1[36][t1[38]] = TextLabel
        t1[36] = t13.timerLabelGui
        t1[38] = "Name"
        t1[36][t1[38]] = "RoundTimerLabel"
        t1[36] = t13.timerLabelGui
        t1[38] = "Size"
    ...
    do
        ...
        t1[36][t1[38]] = GothamMedium
        t1[36] = t13.timerLabelGui
        t1[38] = "TextSize"
        t1[36][t1[38]] = 26
        t1[36] = t13.timerLabelGui
        t1[38] = "TextStrokeTransparency"
        t1[36][t1[38]] = 0.5
        t1[36] = t13.timerLabelGui
        t1[38] = "TextStrokeColor3"

        local color3_5 = Color3.new(0, 0, 0)

        t1[36][t1[38]] = color3_5
        t1[36] = t13.timerLabelGui
        t1[38] = "Text"
        t1[36][t1[38]] = "0:00"
        t1[36] = t13.timerLabelGui
        ...
        t1[36][t1[38]] = floatingGui
        t1[36] = t13
        t1[38] = "grabButton"

        local TextButton = Instance.new("TextButton")

        t1[36][t1[38]] = TextButton
        t1[36] = t13.grabButton
        t1[38] = "Size"
        ...
        t1[36][t1[38]] = color3_6
        t1[36] = t13.grabButton
        t1[38] = "Font"

        local Montserrat = Enum.Font.Montserrat

        t1[36][t1[38]] = Montserrat
        t1[36] = t13.grabButton
        t1[38] = "TextSize"
        t1[36][t1[38]] = 11
        t1[36] = t13.grabButton
        ...
        t1[36][t1[38]] = floatingGui2
        t1[38] = Instance.new("UICorner", t13.grabButton)
        t1[36] = "CornerRadius"
        ...
        t1[36][t1[38]] = color3_7
        t1[36] = t13.gs
        t1[38] = "ApplyStrokeMode"
        ...
        t1[36][t1[38]] = TextButton2
        t1[36] = t13.shootButton
        t1[38] = "Size"
    ...
    t1[36][t1[38]] = floatingGui
    t1[38] = Instance.new("UICorner", t13.shootButton)
    t1[36] = "CornerRadius"
...
do
    ...
    t1[36] = t13.gt.kill
    t1[36]:AddButton("Kill Sheriff", function()
        killSheriff()
    end)
    ...
    t1[36] = t13.gt.farm
    t1[38] = t1[36].AddToggle
    t1[38](t1[36], "AutoFarm", {
		Text = "Auto Farm",
		Default = false,
    ...
    t1[38] = t1[36].AddSlider
    t1[38](t1[36], "AutoFarmTweenSpeed", {
		Text = "Tween Speed",
...
<font color="rgb(255,255,255)">Rate:</font> <font color="rgb(255,120,120)">0/hr</font>]], true)
    ...
    t1[36][t1[38]] = v145
    t1[36] = t13.gt.farmfull
    t1[36]:AddToggle("PostFarmKillMurd", {
    ...
    t1[36] = t13.gt.webhook
    t1[38] = t1[36].AddToggle
    t1[38](t1[36], "WebhookOnFull", {
		Text = "Send on Full",
		Default = false,
    ...
    t1[36] = t13.gt.webhook
    t1[38] = t1[36].AddInput
    t1[40] = function(p130)
        t13.WebhookURL = p130
    end
    t1[38](t1[36], "WebhookURL", {
		Default = "",
		Numeric = false,
		Finished = false,
    ...
    t1[38](t1[36], "WebhookIntervalInput", {
		Default = "10",
		Numeric = true,
		Finished = false,
    ...
    t1[36] = t13.tpgt.locations

    local _teleportToLobby = teleportToLobby

    t1[36]:AddButton("Teleport to Lobby", _teleportToLobby)
    t1[36] = t13.tpgt.locations

    local _teleportToMap = teleportToMap

    t1[36]:AddButton("Teleport to Map", _teleportToMap)
    t1[36] = t13
    t1[38] = "tpPlayerDropdown"
...
do
    ...
    t1[36] = t13.ggt.status
    t1[38] = t1[36].AddToggle
    t1[38](t1[36], "StatusOverlay", {
		Text = "Status Overlay",
		Default = false,
    ...
    t1[36] = t13.ggt.expose

    local _exposeMurderer = exposeMurderer

    t1[36]:AddButton("Expose Murderer", _exposeMurderer)
    ...
    t1[36]:AddButton("Fling Sheriff/Hero", _flingSheriffHero)
    t1[36] = t13.ggt.fling

    local _flingEveryone = flingEveryone

    t1[36]:AddButton("Fling Everyone", _flingEveryone)
    t1[36] = t13
    t1[38] = "flingStatusLabel"
    ...
    t1[36][t1[38]] = v170
    t1[36] = t13.ggt.dualeffect
    t1[38] = t1[36].AddDropdown
    t1[38](t1[36], "DualEffectSelect", {
    ...
    t1[36] = t13.ggt.feanim
    t1[38] = t1[36].AddDropdown
    t1[38](t1[36], "FEAnimAll", {
		Text = "All Animations",
		Values = {
			"Default",
			"Vampire",
...
t1[36] = t13.settingsgt.m
t1[36]:AddButton("Lock Selected", function()
...
t1[36] = t13.settingsgt.m
t1[36]:AddButton("Lock All", function()
...
do
    ...
    t1[36][t1[38]] = {
		...
		OutlineEnabled = t1[39],
		OutlineEveryone = t1[41],
		OutlineMurderer = t1[43],
		OutlineSheriff = t1[45],
		OutlineInnocent = t1[47],
		OutlineGun = t1[49],
		ChamsEnabled = t1[51],
		ChamsEveryone = t1[53],
		ChamsMurderer = t1[55],
		...
		ChamsGun = t1[61],
		ChamsCoin = t1[63],
		TracersEnabled = t1[65],
		TracersEveryone = t1[67],
		TracersMurderer = t1[69],
		TracersSheriff = t1[71],
		TracersInnocent = t1[72],
		TracersGun = t1[73],
		TracersCoin = t1[74],
		BoxEnabled = t1[75],
		BoxEveryone = t1[76],
    ...
    for v175, v176 in t1[36](visualMap) do
        t1[36] = v175

        local v177 = v176

        if t13.Toggles[t1[36]] then
            t13.Toggles[t1[36]]:OnChanged(function(p133)
                t13.espSettings[v177[1]][v177[2]] = p133
            end)
        end
    end

    t1[36] = t13.Toggles.AutoGrab
    t1[36]:OnChanged(function(p134)
        t13.AutoGrab = p134
    end)
    t1[36] = t13.Toggles.GrabButton
    t1[36]:OnChanged(function(p135)
        t13.grabButton.Visible = p135
        setButtonActive(t13.grabButton, false)
    end)
    t1[36] = t13.Toggles.ShootButton
    t1[36]:OnChanged(function(p136)
        t13.shootButton.Visible = p136
        setButtonActive(t13.shootButton, false)
    end)
    t1[36] = t13.Toggles.SilentAim
    t1[36]:OnChanged(function(p137)
        t13.SilentAimEnabled = p137
        applySilentAimState(p137)
    end)
    t1[36] = t13.Toggles.TriggerBot
    t1[36]:OnChanged(function(p138)
    ...
    t1[36] = t13.Toggles.AutoKillAll
    t1[36]:OnChanged(function(p141)
        t13.AutoKillAllEnabled = p141
    end)
    t1[36] = t13.Toggles.NoclipButton
    t1[36]:OnChanged(function(p142)
        t13.noclipButton.Visible = p142
        setButtonActive(t13.noclipButton, t13.Toggles.Noclip.Value)
    end)
    t1[36] = t13.Toggles.XRayButton
    t1[36]:OnChanged(function(p143)
        t13.xrayButton.Visible = p143
        setButtonActive(t13.xrayButton, t13.Toggles.XRay.Value)
    end)
    t1[36] = t13.Toggles.InfiniteJumpButton
    t1[36]:OnChanged(function(p144)
        t13.infjumpButton.Visible = p144
        setButtonActive(t13.infjumpButton, t13.InfJumpEnabled)
    end)
    t1[36] = t13.Toggles.FlyButton
    t1[36]:OnChanged(function(p145)
        t13.flyButton.Visible = p145
        setButtonActive(t13.flyButton, t13.FlyEnabled)
    end)
    t1[36] = t13.Toggles.SpeedGlitchButton
    t1[36]:OnChanged(function(p146)
    ...
    t1[36] = t13.Toggles.KillMurdererButton
    t1[36]:OnChanged(function(p148)
        t13.killMurdererBtn.Visible = p148
        setButtonActive(t13.killMurdererBtn, false)
    end)
    t1[36] = t13.Toggles.KillAllButton
    t1[36]:OnChanged(function(p149)
        t13.killAllBtn.Visible = p149
        setButtonActive(t13.killAllBtn, false)
    end)
    t1[36] = t13.Toggles.FlingMurdererButton
    t1[36]:OnChanged(function(p150)
        t13.flingMurdererBtn.Visible = p150
        setButtonActive(t13.flingMurdererBtn, false)
    end)
    t1[36] = t13.Toggles.FlingSheriffButton
    t1[36]:OnChanged(function(p151)
        t13.flingSheriffBtn.Visible = p151
        setButtonActive(t13.flingSheriffBtn, false)
    end)
    t1[36] = t13.Toggles.FlingEveryoneButton
    t1[36]:OnChanged(function(p152)
    ...
    t1[36] = t13.Toggles.AimlockEnabled
    t1[36]:OnChanged(function(p155)
        toggleAimlock(p155)
    end)
    t1[36] = t13.Toggles.AimlockMurderer
    t1[36]:OnChanged(function(p156)
        t13.AimlockMurderer = p156
    end)
    t1[36] = t13.Toggles.AimlockSheriff
    t1[36]:OnChanged(function(p157)
        t13.AimlockSheriff = p157
    end)
    t13.Toggles.AimlockSelected:OnChanged(function(p158)
        t13.AimlockSelected = p158
    end)
    t1[36] = t13.Options.FlickKey
    t1[36]:OnClick(function()
        doFlick()
    ...
    t1[36] = t13.Options.DualEffectSelect
    t1[36]:OnChanged(function(p160)
        t13.DualEffectSelected = p160
    end)
    t1[36] = t13.Options.AimlockSmoothness
    t1[36]:OnChanged(function(p161)
        t13.AimlockSmoothness = p161
    end)
    t13.Toggles.BombJumpAuto:OnChanged(function(p162)
        t13.BombJumpEnabled = p162
    end)
    t1[36] = t13.Toggles.BombJumpAutoGet
    t1[36]:OnChanged(function(p163)
    ...
    t1[36] = t13.Options.BombJumpKey
    t1[36]:OnClick(function()
        executeBombJump()
    end)
    t1[36] = t13.Toggles.DualEffect
    t1[36]:OnChanged(function(p165)
        t13.DualEffectEnabled = p165
    end)
    t1[36] = t13.Toggles.FEAnim
    t1[36]:OnChanged(function(p166)
    ...
    t1[36] = t13.Options.FEAnimAll
    t1[36]:OnChanged(function(p167)
    ...
    t1[36] = t13.Options.FEAnimIdle
    t1[36]:OnChanged(function(p168)
        if not t13.FEAnimEnabled then
            return
        end
    ...
    t1[36] = t13.Options.FEAnimWalk
    t1[36]:OnChanged(function(p169)
        if not t13.FEAnimEnabled then
            return
        end
    ...
    t1[36] = t13.Options.FEAnimRun
    t1[36]:OnChanged(function(p170)
        if not t13.FEAnimEnabled then
            return
        end
    ...
    t1[36] = t13.Options.FEAnimJump
    t1[36]:OnChanged(function(p171)
        if not t13.FEAnimEnabled then
            return
        end
    ...
    t1[36] = t13.Options.FEAnimClimb
    t1[36]:OnChanged(function(p172)
        if not t13.FEAnimEnabled then
            return
        end
    ...
    t1[36] = t13.Options.FEAnimFall
    t1[36]:OnChanged(function(p173)
        if not t13.FEAnimEnabled then
            return
        end
    ...
    t1[36] = t13.Toggles.Noclip
    t1[36]:OnChanged(function(p174)
    ...
    t1[36] = t13.Toggles.Fly
    t1[36]:OnChanged(function(p177)
        toggleFly(p177)
    ...
    t1[36] = t13.Toggles.Invisible
    t1[36]:OnChanged(function(p179)
        if p179 then
            applyinv()
    ...
    t1[36] = t13.Toggles.AntiFling
    t1[36]:OnChanged(function(p180)
    ...
    t1[36] = t13.Toggles.TouchFling
    t1[36]:OnChanged(function(p181)
        toggleTouchFling(p181)
        setButtonActive(t13.touchFlingBtn, p181)
    end)
    t1[36] = t13.Toggles.InstantRoleNotify
    t1[36]:OnChanged(function()
    end)
    t1[36] = t13.Toggles.ShowMurdererChance
    t1[36]:OnChanged(function()
    end)
    t1[36] = t13.Toggles.ShowRoundTimer
    t1[36]:OnChanged(function(p182)
        t13.timerLabelGui.Visible = p182
    end)
    t13.Toggles.ExposeRoles:OnChanged(function()
    end)
    t1[36] = t13.wsSlider
    t1[36]:OnChanged(function(p183)
        t13.wsValue = p183
        applyMovement()
    end)
    t1[36] = t13.jpSlider
    t1[36]:OnChanged(function(p184)
        t13.jpValue = p184
        applyMovement()
    end)
    t1[36] = t13.predToggle
    t1[36]:OnChanged(function(p185)
        t13.PredictionEnabled = p185
        savePredictionConfig()
    end)
    t1[36] = t13.predSlider
    t1[36]:OnChanged(function(p186)
        t13.PredictionMultiplier = p186
        savePredictionConfig()
    end)
    t1[36] = t13.yminSlider
    t1[36]:OnChanged(function(p187)
        t13.YClampMin = p187
        savePredictionConfig()
    end)
    ...
    t1[36] = t13.Toggles.AutoKillMurderer
    t1[36]:OnChanged(function(p189)
        t13.AutoKillMurdererEnabled = p189
    end)
    t1[36] = t13.Options.KillMurdererKey
    t1[36]:OnClick(function()
        killMurderer()
    end)
    ...
    t1[36] = t13.Options.ShootMurdererKey
    t1[36]:OnClick(function()
        shootmurd()
    end)
    t1[36] = t13.Options.ThrowKey
    t1[36]:OnClick(function()
        throwKnife()
    end)
    t1[36] = t13.Options.AutoKillKey
    t1[36]:OnClick(function()
        killAll()
    end)
    t1[36] = t13.Options.BlurtSheriffKey
    t1[36]:OnClick(function()
        blurtSheriff()
    end)
    ...
    t1[36] = t13.Options.BlurtBothKey
    t1[36]:OnClick(function()
        blurtBoth()
    end)
    t1[36] = t13.Options.ExposeSheriffKey
    t1[36]:OnClick(function()
        exposeSheriff()
    end)
    t1[36] = t13.Options.ExposeMurdererKey
    t1[36]:OnClick(function()
        exposeMurderer()
    end)
    ...
    t1[36][t1[38]] = connection
    setupTimerListener()
    t1[36] = t13
    t1[38] = "gameplayRemotes"
    ...
    if t1[38].gameplayRemotes then
        do
            t1[36] = t13
            t1[38] = "gameplayFolder"

            local Gameplay = t13.gameplayRemotes:FindFirstChild("Gameplay", true)

            t1[36][t1[38]] = Gameplay
        end

        t1[38] = t13

        if t1[38].gameplayFolder then
            do
                t1[36] = t13
                t1[38] = "dataEvent"
            ...
            if dataEvent then
                t1[36] = t13.dataEvent.OnClientEvent
            end

            if t1[36] then
                t1[36] = t13.dataEvent.OnClientEvent
                t1[36]:Connect(function(p190)
    ...
    t1[36][t1[38]] = connection7
    t1[36] = t13.Connections
    t1[38] = "autoKillMurdererConn"
    ...
    t1[36][t1[38]] = connection9
    t1[36] = t13.Connections
    t1[38] = "triggerbotLoop"
    ...
    t1[36][t1[38]] = connection10
    t1[36] = t13.uis.JumpRequest
    t1[36]:Connect(function()
    ...
    t1[36] = t13.uis.InputBegan
    t1[36]:Connect(function(p191, p192)
        if not p192 then
    ...
    t1[38] = "Name"
    ScreenGui[t1[38]] = "CustomButtonGui"
    t1[38] = "ResetOnSpawn"
    ScreenGui[t1[38]] = false
    t1[38] = "IgnoreGuiInset"
    ScreenGui[t1[38]] = true
    t1[38] = "DisplayOrder"
    ScreenGui[t1[38]] = 999999999
    t1[38] = "ZIndexBehavior"

    local Sibling = Enum.ZIndexBehavior.Sibling

    ScreenGui[t1[38]] = Sibling
end
ScreenGui.Parent = t1[36]
local TextButton = Instance.new("TextButton")
...
for _, descendant in ipairs(t13.w:GetDescendants()) do
    t1[39] = descendant.Name == "CoinContainer"

    local v207 = t1[39]

    if t1[39] then
        t1[41] = descendant:IsA("Folder")
        t1[39] = t1[41]

        if not t1[41] then
            t1[39] = descendant:IsA("Model")
        end
...
t13.AutoRejoinErrorConn = ErrorMessageChanged:Connect(t1[39])
t13.lp.CharacterAdded:Connect(function(character)
    if t13.isFlinging then
        cleanupFling()
    end
